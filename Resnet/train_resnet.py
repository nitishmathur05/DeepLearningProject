...
if __name__ == '__main__':
  ...
  parser.add_argument(
      '--output_graph',
      type=str,
      default='/mnt/project/NASnet/output_graph_oct_16.pb',
      help='Where to save the trained graph.'
  )
  parser.add_argument(
      '--intermediate_output_graphs_dir',
      type=str,
      default='/mnt/project/NASnet/intermediate_graph/',
  ...
  parser.add_argument(
      '--output_labels',
      type=str,
      default='/mnt/project/NASnet/output_labels_oct_16.txt',
      help='Where to save the trained graph\'s labels.'
  )
  parser.add_argument(
      '--summaries_dir',
      type=str,
      default='/mnt/project/NASnet/retrain_logs_oct_16',
  ...
  parser.add_argument(
      '--bottleneck_dir',
      type=str,
      default='/mnt/project/NASnet/bottleneck',
  ...
  parser.add_argument(
      ...
      type=str,
      default=(
          'https://tfhub.dev/google/imagenet/nasnet_large/feature_vector/3'),
      help="""\
  ...
  parser.add_argument(
      '--checkpoint_path',
      type=str,
      default='/mnt/project/NASnet/_retrain_checkpoint',
